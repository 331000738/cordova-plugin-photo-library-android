[![Build Status](https://travis-ci.org/terikon/cordova-plugin-photo-library-android.svg?branch=master)](https://travis-ci.org/terikon/cordova-plugin-photo-library-android)
...
Currently Android code is pretty stable, iOS has few stability [issues](https://github.com/terikon/cordova-plugin-photo-library-android/issues).
...
# Install
    ...
    cordova plugin add cordova-plugin-photo-library-android --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="To choose photos" --save
...
As mentioned [here](https://github.com/terikon/cordova-plugin-photo-library-android/issues/15) by dnmd, cdvphotolibrary urls should bypass sanitization to work.
...
TypeScript definitions are provided in [PhotoLibrary.d.ts](https://github.com/terikon/cordova-plugin-photo-library-android/blob/master/PhotoLibrary.d.ts)

# Tests

The library includes tests in [tests](https://github.com/terikon/cordova-plugin-photo-library-android/tree/master/tests) folder. All tests are in
[tests.js](https://github.com/terikon/cordova-plugin-photo-library-android/blob/master/tests/tests.js) file.
...
- [#38](https://github.com/terikon/cordova-plugin-photo-library-android/issues/38) browser platform: saveImage and saveVideo should download file.
